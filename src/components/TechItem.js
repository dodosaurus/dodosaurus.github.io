...
const TechItem = ({ tech, setTechDetails, type }) => {
  ...
  return (
    <button className={`no-select tech-item outline-none flex mt-1 p-1 justify-center items-center cursor-pointer hover:text-${type} transition ease-linear duration-300 font-light`} onClick={ handleClick }>
      {/* <div
